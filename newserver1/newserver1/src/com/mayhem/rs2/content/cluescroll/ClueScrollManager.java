...
public enum ClueScrollManager {
	...
	/**
	 * The casket (hard1) item id.
	 */
	public static final int CASKET_HARD1 = 2775;
	...
	public static final Chance<Item> HARD1 = new Chance<Item>();
	...
	public static void declare() {
		...
		HARD1.add(200, new Item(1079, 1)); // Rune platelegs
		HARD1.add(200, new Item(1093, 1)); // Rune plateskirt
		HARD1.add(200, new Item(1113, 1)); // Rune chainbody
		HARD1.add(200, new Item(1127, 1)); // Rune platebody
		HARD1.add(200, new Item(1147, 1)); // Rune med helm
		HARD1.add(200, new Item(1163, 1)); // Rune full helm
		HARD1.add(200, new Item(1185, 1)); // Rune sq shield
		HARD1.add(200, new Item(1201, 1)); // Rune kiteshield
		HARD1.add(200, new Item(1213, 1)); // Rune dagger
		HARD1.add(200, new Item(1289, 1)); // Rune sword
		HARD1.add(200, new Item(1303, 1)); // Rune longsword
		HARD1.add(200, new Item(1319, 1)); // Rune 2h sword
		HARD1.add(200, new Item(1333, 1)); // Rune scimitar
		HARD1.add(200, new Item(1347, 1)); // Rune warhammer
		HARD1.add(200, new Item(1359, 1)); // Rune axe
		HARD1.add(200, new Item(1373, 1)); // Rune battleaxe
		HARD1.add(200, new Item(1432, 1)); // Rune mace
		HARD1.add(200, new Item(859, 1)); // Magic longbow
		HARD1.add(200, new Item(861, 1)); // Magic shortbow
		HARD1.add(200, new Item(2497, 1)); // Black d'hide chaps
		HARD1.add(200, new Item(2503, 1)); // Black d'hide body
		HARD1.add(200, new Item(2491, 1)); // Black d'hide vamb
		HARD1.add(200, new Item(385, 1)); // Shark
		HARD1.add(200, new Item(379, 1)); // Lobster
		HARD1.add(35, new Item(12526, 1)); // Fury ornament kit
		HARD1.add(35, new Item(12532, 1)); // Dragon sq shield ornament kit
		HARD1.add(35, new Item(12534, 1)); // Dragon chainbody ornament kit
		HARD1.add(35, new Item(12536, 1)); // Dragon plate/skirt ornament kit
		HARD1.add(35, new Item(12538, 1)); // Dragon full helm ornament kit
		HARD1.add(35, new Item(12528, 1)); // Dark infinity colour kit
		HARD1.add(35, new Item(12530, 1)); // Light infinity colour kit
		HARD1.add(15, new Item(12381, 1)); // Black d'hide body (g)
		HARD1.add(15, new Item(12383, 1)); // Black d'hide chaps (g)
		HARD1.add(15, new Item(12385, 1)); // Black d'hide body (t)
		HARD1.add(15, new Item(12387, 1)); // Black d'hide chaps (t)
		HARD1.add(15, new Item(2615, 1)); // Rune platebody (g)
		HARD1.add(15, new Item(2617, 1)); // Rune platelegs (g)
		HARD1.add(15, new Item(2619, 1)); // Rune full helm (g)
		HARD1.add(15, new Item(2621, 1)); // Rune kiteshield (g)
		HARD1.add(15, new Item(2623, 1)); // Rune platebody (t)
		HARD1.add(15, new Item(2625, 1)); // Rune platelegs (t)
		HARD1.add(15, new Item(2627, 1)); // Rune full helm (t)
		HARD1.add(15, new Item(2629, 1)); // Rune kiteshield (t)
		HARD1.add(15, new Item(3476, 1)); // Rune plateskirt (g)
		HARD1.add(15, new Item(3477, 1)); // Rune plateskirt (t)
		HARD1.add(65, new Item(2669, 1)); // Guthix platebody
		HARD1.add(65, new Item(2671, 1)); // Guthix platelegs
		HARD1.add(65, new Item(2673, 1)); // Guthix full helm
		HARD1.add(65, new Item(2675, 1)); // Guthix kiteshield
		HARD1.add(65, new Item(3480, 1)); // Guthix plateskirt
		HARD1.add(65, new Item(2653, 1)); // Zamorak platebody
		HARD1.add(65, new Item(2655, 1)); // Zamorak platelegs
		HARD1.add(65, new Item(2657, 1)); // Zamorak full helm
		HARD1.add(65, new Item(2659, 1)); // Zamorak kiteshield
		HARD1.add(65, new Item(3478, 1)); // Zamorak plateskirt
		HARD1.add(65, new Item(2661, 1)); // Saradomin platebody
		HARD1.add(65, new Item(2663, 1)); // Saradomin platelegs
		HARD1.add(65, new Item(2665, 1)); // Saradomin full helm
		HARD1.add(65, new Item(2667, 1)); // Saradomin kiteshield
		HARD1.add(65, new Item(3479, 1)); // Saradomin plateskirt
		HARD1.add(25, new Item(3481, 1)); // Gilded platebody
		HARD1.add(25, new Item(3483, 1)); // Gilded platelegs
		HARD1.add(25, new Item(3485, 1)); // Gilded plateskirt
		HARD1.add(25, new Item(3486, 1)); // Gilded full helm
		HARD1.add(25, new Item(3488, 1)); // Gilded kiteshield
		HARD1.add(25, new Item(12389, 1)); // Gilded scimitar
		HARD1.add(25, new Item(12391, 1)); // Gilded boots
		HARD1.add(100, new Item(7336, 1)); // Rune shield (h1)
		HARD1.add(100, new Item(7342, 1)); // Rune shield (h2)
		HARD1.add(100, new Item(7348, 1)); // Rune shield (h3)
		HARD1.add(100, new Item(7354, 1)); // Rune shield (h4)
		HARD1.add(100, new Item(7360, 1)); // Rune shield (h5)
		HARD1.add(100, new Item(10286, 1)); // Rune helm (h1)
		HARD1.add(100, new Item(10288, 1)); // Rune helm (h2)
		HARD1.add(100, new Item(10290, 1)); // Rune helm (h3)
		HARD1.add(100, new Item(10292, 1)); // Rune helm (h4)
		HARD1.add(100, new Item(10294, 1)); // Rune helm (h5)
		HARD1.add(65, new Item(7374, 1)); // Blue d'hide body (g)
		HARD1.add(65, new Item(7376, 1)); // Blue d'hide body (t)
		HARD1.add(65, new Item(7382, 1)); // Blue d'hide chaps (g)
		HARD1.add(65, new Item(7384, 1)); // Blue d'hide chaps (t)
		HARD1.add(65, new Item(7398, 1)); // Enchanted robe
		HARD1.add(65, new Item(7399, 1)); // Enchanted top
		HARD1.add(65, new Item(7400, 1)); // Enchanted hat
		HARD1.add(10, new Item(2581, 1)); // Robin hood hat
		HARD1.add(35, new Item(2639, 1)); // Tan cavalier
		HARD1.add(35, new Item(2641, 1)); // Dark cavalier
		HARD1.add(35, new Item(2643, 1)); // Black cavalier
		HARD1.add(35, new Item(12321, 1)); // White cavalier
		HARD1.add(35, new Item(12323, 1)); // Red cavalier
		HARD1.add(35, new Item(12325, 1)); // Navy cavalier
		HARD1.add(45, new Item(2651, 1)); // Pirate's hat
		HARD1.add(5, new Item(10346, 1)); // 3rd age platelegs
		HARD1.add(5, new Item(10348, 1)); // 3rd age platebody
		HARD1.add(5, new Item(10350, 1)); // 3rd age full helmet
		HARD1.add(5, new Item(10352, 1)); // 3rd age kiteshield
		HARD1.add(5, new Item(10330, 1)); // 3rd age range top
		HARD1.add(5, new Item(10332, 1)); // 3rd age range legs
		HARD1.add(5, new Item(10334, 1)); // 3rd age range coif
		HARD1.add(5, new Item(10336, 1)); // 3rd age vambraces
		HARD1.add(5, new Item(10338, 1)); // 3rd age robe top
		HARD1.add(5, new Item(10340, 1)); // 3rd age robe
		HARD1.add(5, new Item(10342, 1)); // 3rd age mage hat
		HARD1.add(5, new Item(10344, 1)); // 3rd age amulet
		HARD1.add(5, new Item(12422, 1)); // 3rd age wand
		HARD1.add(5, new Item(12424, 1)); // 3rd age bow
		HARD1.add(5, new Item(12426, 1)); // 3rd age longsword
		HARD1.add(5, new Item(12437, 1)); // 3rd age cloak
		HARD1.add(25, new Item(10382, 1)); // Guthix coif
		HARD1.add(25, new Item(10380, 1)); // Guthix chaps
		HARD1.add(25, new Item(10378, 1)); // Guthix dragonhide
		HARD1.add(25, new Item(10376, 1)); // Guthix bracers
		HARD1.add(25, new Item(10390, 1)); // Saradomin coif
		HARD1.add(25, new Item(10388, 1)); // Saradomin chaps
		HARD1.add(25, new Item(10386, 1)); // Saradomin d'hide
		HARD1.add(25, new Item(10384, 1)); // Saradomin bracers
		HARD1.add(25, new Item(10374, 1)); // Zamorak coif
		HARD1.add(25, new Item(10372, 1)); // Zamorak chaps
		HARD1.add(25, new Item(10370, 1)); // Zamorak d'hide
		HARD1.add(25, new Item(10368, 1)); // Zamorak bracers
		HARD1.add(25, new Item(12512, 1)); // Armadyl coif
		HARD1.add(25, new Item(12510, 1)); // Armadyl chaps
		HARD1.add(25, new Item(12508, 1)); // Armadyl d'hide
		HARD1.add(25, new Item(12506, 1)); // Armadyl bracers
		HARD1.add(25, new Item(12496, 1)); // Ancient coif
		HARD1.add(25, new Item(12494, 1)); // Ancient chaps
		HARD1.add(25, new Item(12492, 1)); // Ancient d'hide
		HARD1.add(25, new Item(12490, 1)); // Ancient bracers
		HARD1.add(25, new Item(12504, 1)); // Bandos coif
		HARD1.add(25, new Item(12502, 1)); // Bandos chaps
		HARD1.add(25, new Item(12500, 1)); // Bandos d'hide
		HARD1.add(25, new Item(12498, 1)); // Bandos bracers
		HARD1.add(47, new Item(12518, 1)); // Green dragon mask
		HARD1.add(47, new Item(12520, 1)); // Blue dragon mask
		HARD1.add(47, new Item(12522, 1)); // Red dragon mask
		HARD1.add(47, new Item(12524, 1)); // Black dragon mask
		HARD1.add(47, new Item(12516, 1)); // Pith helmet
		HARD1.add(20, new Item(12269, 1)); // Bandos stole
		HARD1.add(20, new Item(12257, 1)); // Armadyl stole
		HARD1.add(20, new Item(12201, 1)); // Ancient stole
		HARD1.add(20, new Item(10474, 1)); // Zamorak stole
		HARD1.add(20, new Item(10472, 1)); // Guthix stole
		HARD1.add(20, new Item(10470, 1)); // Saradomin stole
		HARD1.add(20, new Item(12275, 1)); // Bandos crozier
		HARD1.add(20, new Item(12263, 1)); // Armadyl crozier
		HARD1.add(20, new Item(12199, 1)); // Ancient crozier
		HARD1.add(20, new Item(10444, 1)); // Zamorak crozier
		HARD1.add(20, new Item(10442, 1)); // Guthix crozier
		HARD1.add(20, new Item(10440, 1)); // Saradomin crozier
		HARD1.add(10, new Item(12379, 1)); // Rune cane
		HARD1.add(10, new Item(20014, 1)); // 3rd age pickaxe
		HARD1.add(10, new Item(20011, 1)); // 3rd age axe
		HARD1.add(10, new Item(19687, 1)); // clue hunter
		HARD1.add(10, new Item(19697, 1)); // clue hunter
		HARD1.add(10, new Item(19689, 1)); // clue hunter
		HARD1.add(10, new Item(19693, 1)); // clue hunter
		HARD1.add(10, new Item(19695, 1)); // clue hunter
		HARD1.add(10, new Item(19691, 1)); // clue hunter
		...
		CLUE_SCROLLS.put(2680, new EmoteScroll(2680, ClueDifficulty.EASY, new Item[] { new Item(579), null, null, new Item(1307), null, null, null, null, null, null, new Item(1061), null, null, null }, new Location(2927, 3484, 0), 5, 862, "", "", "Cheer at the Druids' Circle. Equip", "a blue wizard hat, a bronze two-", "handed sword and leather boots.", "", "", "", ""));
