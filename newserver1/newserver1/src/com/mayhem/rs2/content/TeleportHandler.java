...
public class TeleportHandler {
	...
	public enum TeleportationData {
		...
		SAND_CRABS(238124, "None", "None", "None", 0, new Location(1887, 3771, 0), false, false),
		...
		ZULRAH(250057, "None", "High combat", "Hard", 725, new Location(2196, 3052, 0), false, false),
		KRAKEN(250058, "None", "Task only", "", 291, new Location(2278, 10016, 0), false, false),
		...
		TORMENTED_DEMON(250062, "None", "High combat", "50+ Wild", 225, new Location(1884, 3811, 0), false, false),
		...
		THERMO(250068, "None", "High combat", "Instanced", 318, new Location(2368, 9449, 0), false, false),
	...
	public static boolean specialCase(Player player, int buttonId) {
		...
		case 250068://Thermo
			...
			@Override
			public void execute() {
				new Mob(player, 499, true, false, false, new Location(2404, 9416, player.getIndex() << 2));
