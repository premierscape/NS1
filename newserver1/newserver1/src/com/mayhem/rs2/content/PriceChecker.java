...
public class PriceChecker extends ItemContainer {
	...
	public void update() {
		...
		//player.send(new SendString(""+ NumberFormat.getInstance().format(50.9, 48513));
	}
	...
	public void store(int id, int amount) {
		...
		if (!Item.getDefinition(id).isTradable() || Item.getDefinition(id).getName().contains("asdasdasd")) {
