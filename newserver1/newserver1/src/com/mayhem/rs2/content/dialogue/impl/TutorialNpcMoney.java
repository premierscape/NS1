...
public class TutorialNpcMoney extends Dialogue {
	...
	public void execute() {
		...
		/*case 5:
			...
			break;*/
		case 6:
			nChat(new String[] { "Like every skill on GrandLegion,", "You will receive skill points to be spent", "in the skill points shop on useful supplies!" });
			break;
		case 7:
			tele(3088, 3490);
			nChat(new String[] { "There are MANY more ways to get rich on GrandLegion.", "You can farm clue scrolls from monsters.", "Loads of @blu@NEW items</col> have been added to clues." });
			break;
		case 8:
			nChat(new String[] { "Monsters around GrandLegion also drop Crystal Keys commonly", "and with the crystal chest now packed with 100s", "of new items, it's a great way to make BANK!" });
			break;
		case 9:
			nChat(new String[] { "Bloodmoney is also a second currency on GrandLegion,", "with many of its own shops", "to purchase items." });
			break;
		case 10:
			nChat(new String[] { "You receive blood money for doing many things", "around GrandLegion such as killing monsters", "killing other players & random drops." });
			break;
		case 11:
