...
public class Tutorial extends Dialogue {
	...
	public void execute() {
		...
		case 0:
			DialogueManager.sendNpcChat(player, GUIDE, Emotion.HAPPY_TALK, "Hello @blu@" + player.getUsername() + "</col>, Welcome to GrandLegion!", "Would you like a quick tour of our home area?");
			next++;
			break;
		case 1:
		...
		case 5:
			...
			break;
		case 6:
			nChat(new String[] { "Skilling is a great place to start on GrandLegion.", "You can recieve many Experience boosting items", "RANDOMLY while skilling!" });
			break;
		case 7:
