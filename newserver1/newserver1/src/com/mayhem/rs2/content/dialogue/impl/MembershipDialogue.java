...
public class MembershipDialogue extends Dialogue {
	...
	public void execute() {
		...
		case 0:
			...
			break;
		case 1:
			DialogueManager.sendOption(player, "What are GrandLegion Credits?", "Benifits of membership", "I have purchased something", "Update rank", "Nevermind");
			break;
		case 2:
			DialogueManager.sendNpcChat(player, 7042, Emotion.DEFAULT, "GrandLegion Credits can be purchased on our online store.", "They can be used for buying items from my store ", "and many other features in game.", "Including purchasing GrandLegion Credits in the Shops tab.");
			setNext(1);
			break;
		case 3:
