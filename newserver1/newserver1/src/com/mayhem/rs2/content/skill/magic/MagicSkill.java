...
public class MagicSkill {
	...
	public boolean needsRune(int runeId) {
		...
		case 556:
			...
			return true;
		case 554:
			if ((wep == 1387) || (wep == 1393) || (wep == 17293)|| ((shield != null) && (shield.getId() == 20714))) {
				return false;
			}
			return true;
		case 555:
			if ((wep == 1383) || (wep == 20730) || (wep == 20733) || (wep == 1395) || (wep == 17293)|| (wep == 21006) || ((shield != null) && (shield.getId() == 18346))) {
				return false;
			}
			return true;
		case 557:
