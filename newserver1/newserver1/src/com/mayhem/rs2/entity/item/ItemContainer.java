...
public abstract class ItemContainer {
	...
	public ItemContainer(Player player, int size, ContainerTypes type, boolean shift, boolean acceptNote) {
		this.size = size;
		this.type = type;
		this.shift = shift;
		this.acceptNote = acceptNote;
	...
	public boolean hasItemByName(String name) {
		for (Item i : items)
			if (i != null && i.getDefinition().getName().equals(name))
				return true;
		return false;
	}
	...
	public boolean hasItemId(int id) {
		return hasItemAmount(new Item(id, 0));
	}
	...
	public int remove(Item item, boolean update) {
        ...
        boolean leavePlaceHolder = (this instanceof Bank
                && this.player != null && this.player.isPlaceholders());
