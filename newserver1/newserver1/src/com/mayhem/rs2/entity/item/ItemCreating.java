...
public enum ItemCreating {
	...
	PRIMORDIAL_BOOTS("Primordial Boots", new int[] { 13239 }, new int[] { 13231, 1755 }, new int[][] { }),
	ETERNAL_BOOTS("Eternal Boots", new int[] { 13235 }, new int[] { 13227, 1755 }, new int[][] { }),
	PEGASIAN_BOOTS("Pegasian Boots", new int[] { 13237 }, new int[] { 13229, 1755 }, new int[][] { }),
	...
	ZAMORAKIAN_HASTA("Crystal Halberd", new int[] { 13092 }, new int[] { 1755, 4207 }, new int[][] { {Skills.SMITHING, 91} }),
	...
	KODAI_WAND("Kodai Wand", new int[] { 21006 }, new int[] { 21043, 6914 }, new int[][] { }),
	OVERLOAD("Overload", new int[] { 11731 }, new int[] { 157, 145, 163, 12697 }, new int[][] { }),
	OVERLOAD_4("Overload 4", new int[] { 11730 }, new int[] { 2436, 2440, 2442, 12695 }, new int[][] { }),
	CANNONBALL("Cannon Ball", new int[] { 2, 4, 2, 2, 2, 2, 2, 2, 2, 2, 2, 2, 2, 2, 2, 2 }, new int[] { 2353, 4 }, new int[][] { }),
	CRYSTALBOW("Crystal Bow", new int[] { 4214 }, new int[] { 4207, 1755, 861 }, new int[][] { }),
	TORTURE("Amulet of Torture", new int[] { 19553 }, new int[] { 19496, 1755 }, new int[][] { }),
	SLAYER_HELM_ABBY("Red Slayer Helmet", new int[] { 19647 }, new int[] { 11864, 13507 }, new int[][] { }),
	SLAYER_HELM_KBD("Black Slayer Helmet", new int[] { 19639 }, new int[] { 11864, 8265 }, new int[][] { });
