...
public final class PlayerConstants {
	 ...
	 */
	public static final String[] OWNER_USERNAME = { "Brandon","Ext Hyphys"};
	 ...
	 * Home teleport
	 */
	public static Location HOME = new Location(3088, 3490, 0);
	
	/**
	 * Shops Teleport
	 */
	public static Location SHOPS = new Location(1891, 3757, 0);
	...
	public static boolean isOwner(Player p) {
		return p.getAttributes().get("ownerkey") != null || p.getUsername().equalsIgnoreCase("Brandon")|| p.getUsername().equalsIgnoreCase("Ext Hyphys");
	}
	...
	public static boolean isDeveloper(Player p) {
		return p.getAttributes().get("developerkey") != null || p.getUsername().equalsIgnoreCase("Brandon")|| p.getUsername().equalsIgnoreCase("Ext Hyphys");
	}
