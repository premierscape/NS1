...
public class ObjectManager {
	...
	public static void declare() {
		...
		spawnWithObject(13618, 3084, 3492, 0, 10, 3);//Bank
		spawnWithObject(13619, 3084, 3494, 0, 10, 3);//Bank
		...
		spawnWithObject(29170, 3094, 3505, 0, 10, 2);//max cape
		spawnWithObject(29171, 3095, 3505, 0, 10, 2);//max cape
		spawnWithObject(29175, 3096, 3505, 0, 10, 2);//max cape
		spawnWithObject(29172, 3097, 3505, 0, 10, 2);//max cape
		spawnWithObject(29174, 3098, 3505, 0, 10, 2);//max cape
		spawnWithObject(29173, 3099, 3505, 0, 10, 2);//max cape
		spawnWithObject(14503, 1627, 3658, 0, 10, 0);
		spawnWithObject(14503, 1630, 3658, 0, 10, 0);
		spawnWithObject(27282, 3285, 3946, 0, 10, 0);
